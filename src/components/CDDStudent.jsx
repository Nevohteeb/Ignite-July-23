        ...
        <div className="page-container">
            ...
            <div className="personal-info" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className="personal-img-cont">
                    <img className="studentImageCDD" src={student.headshot} alt={student.name + ' headshot'} />
                </div>
                ...
                <div className="personal-details">
                    ...
                    <div className="social-links">
                        <a href={student.behance} target="_blank"><i className="fa-brands fa-square-behance cdd-social-icons"></i></a>
